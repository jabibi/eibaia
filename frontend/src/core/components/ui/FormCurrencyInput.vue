...
<template>
  <input
    ...
    autocomplete="off"
    :disabled="disabled"
    class="w-full rounded-md border border-slate-300 bg-white px-3 py-1.5 text-right text-xs text-slate-700 shadow-sm transition-colors focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 md:text-sm disabled:cursor-not-allowed disabled:opacity-60"
    @focus="handleFocus"
    @input="handleInput"
    @blur="handleBlur"
  />
